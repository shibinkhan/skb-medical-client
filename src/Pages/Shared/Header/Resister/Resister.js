        ...
        <div className="signinBody">
            <div className="signin-main mx-auto pt-5 mt-5">
                ...
                <form onSubmit={handleResistration}>
                    ...
                    <input className="input-field" onBlur={handlePasswordInput} type="password" placeholder="Password..." required /><br />
                    <input className="input-field" type="password" placeholder="Confirm Password..." /><br /><br />
